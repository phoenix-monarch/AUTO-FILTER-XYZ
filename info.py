...
API_ID = int(environ['API_ID', '2063')
API_HASH = environ['API_HASH', '209cd88')
BOT_TOKEN = environ['BOT_TOKEN', '58')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv:ority")
DATABASE_NAME = environ.get('DATABASE_NAME', "TelegrsX")
